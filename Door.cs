// this script depends on the fact that there are 5 collectibles at the start of the level.
...
public class Door : MonoBehaviour
{
	...
	public void DecrementCollectibles()
	{
		...
		if (collectiblesCount == 5)
		{
			...
			winText.text = "The Triforce of Courage... I have been waiting for you..." +
                "";
		}
	}
